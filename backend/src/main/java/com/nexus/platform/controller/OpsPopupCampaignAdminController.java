...
import com.nexus.platform.service.OpsPopupCampaignService;
...
@RestController
@RequestMapping("/admin/ops/popup-campaigns")
@RequiredArgsConstructor
public class OpsPopupCampaignAdminController {
    private final OpsPopupCampaignService service;
    ...
    public Result<OpsPopupCampaignDto> create(
            @RequestBody OpsPopupCampaignUpsertRequest request,
    ...
    @PutMapping("/{id}")
    @PreAuthorize("@rolePermissionService.hasPermission(authentication, T(com.nexus.platform.security.Permission).ANDROID_ADMIN_WRITE)")
    public Result<OpsPopupCampaignDto> update(
    ...
    @PreAuthorize("@rolePermissionService.hasPermission(authentication, T(com.nexus.platform.security.Permission).ANDROID_ADMIN_WRITE)")
    public Result<OpsPopupCampaignDto> updateStatus(
            @PathVariable Long id,
            @RequestBody OpsPopupCampaignStatusRequest request,
            @AuthenticationPrincipal User currentUser,
            jakarta.servlet.http.HttpServletRequest httpRequest
    ) {
