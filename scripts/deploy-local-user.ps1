...
Write-Host "This helper mirrors scripts/start-local.ps1."
Write-Host "It launches infrastructure, backend, dev portal, and ops portal with the current local env baseline."
