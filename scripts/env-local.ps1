...
$env:PLATFORM_ALLOW_INSECURE_DEFAULTS = "true"
$env:PLATFORM_CORS_ALLOWED_ORIGIN_PATTERNS = "http://localhost:5173,http://localhost:5174,http://127.0.0.1:5173,http://127.0.0.1:5174"
...
Write-Host "PLATFORM_CORS_ALLOWED_ORIGIN_PATTERNS=$env:PLATFORM_CORS_ALLOWED_ORIGIN_PATTERNS"
